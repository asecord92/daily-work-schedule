...
for(var i=0; i<timeBlockArr.length; i++){
    ...
    timeBlockText.setAttribute("id", "selectEl" + i)
    ...
    timeBlockBtn.setAttribute("id", "selectEl" + i);
...
function saveTask() {
    var selectedText = textAreaEl.id

    var selectedBtn = saveBtnEl.id

    if(selectedText == selectedBtn) {
        console.log(success);
    }
